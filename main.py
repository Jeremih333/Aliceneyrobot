...
# Список эмодзи для использования (сокращенный список для более естественного использования)
EMOJI_LIST = ["😊", "😂", "😍", "🤔", "😎", "👍", "❤️", "✨", "🎉", "💔"]
...
# Функция для добавления эмодзи в конце сообщения
def add_emojis(text: str) -> str:
    if not text:
        return text
    
    # Добавляем 1-2 случайных эмодзи только в конце всего сообщения
    emoji_count = random.randint(1, 2)
    selected_emojis = ''.join(random.sample(EMOJI_LIST, k=emoji_count))
    
    # Убедимся, что не добавляем эмодзи, если они уже есть в конце
...
def clean_response(response: str) -> str:
    ...
    # Добавляем эмодзи только в конце всего сообщения
